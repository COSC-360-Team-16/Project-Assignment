...
<html>
    ...
    <body>
        ...
        <h1 style = "text-align: center;">Outlast 2</h1> 
        ...
        <img src = "picture/Outlast2.png" alt = "Outlast 2" height="auto" width="auto">
        ...
        <img src = "picture/outlast1.jfif" alt = "Outlast 2" height="500px" width="auto">
        <div class = "footer">
